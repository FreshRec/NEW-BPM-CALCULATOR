...
\f0\fs24 \cf0 import React, \{ useState, useCallback, useMemo, useRef, useEffect \} from 'react';\
\
...
\
        \} catch (err) \{\
            ...
            setMicError("\uc0\u1053 \u1077  \u1091 \u1076 \u1072 \u1083 \u1086 \u1089 \u1100  \u1087 \u1086 \u1083 \u1091 \u1095 \u1080 \u1090 \u1100  \u1076 \u1086 \u1089 \u1090 \u1091 \u1087  \u1082  \u1084 \u1080 \u1082 \u1088 \u1086 \u1092 \u1086 \u1085 \u1091 . \u1055 \u1088 \u1086 \u1074 \u1077 \u1088 \u1100 \u1090 \u1077  \u1088 \u1072 \u1079 \u1088 \u1077 \u1096 \u1077 \u1085 \u1080 \u1103 .");\
            stopMicListener();\
        \}\
    \};\
\
...
\
      <div className="w-full border-t border-slate-800 pt-8 flex flex-col items-center gap-6">\
          <h3 className="text-lg font-semibold text-slate-300">\uc0\u1054 \u1087 \u1088 \u1077 \u1076 \u1077 \u1083 \u1077 \u1085 \u1080 \u1077  \u1087 \u1086  \u1084 \u1080 \u1082 \u1088 \u1086 \u1092 \u1086 \u1085 \u1091 </h3>\
          <div className="flex items-center gap-6 w-full max-w-xs">\
            ...
            >\
                \{isListeningMic ? '\uc0\u1057 \u1058 \u1054 \u1055 ' : '\u1053 \u1040 \u1063 \u1040 \u1058 \u1068 '\}\
            </button>\
          </div>\
...
\
      <div className="w-full border-t border-slate-800 pt-8">\
        <h3 className="text-lg font-semibold text-center mb-4">\uc0\u1044 \u1083 \u1080 \u1090 \u1077 \u1083 \u1100 \u1085 \u1086 \u1089 \u1090 \u1080  \u1085 \u1086 \u1090  (\u1084 \u1089 )</h3>\
